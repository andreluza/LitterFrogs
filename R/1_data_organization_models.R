...
# ----------------------------------------- #
# create a directory to host the results
# ----------------------------------------- #
...
# create a directory for vectorized format of figures
dir.create("output/vectorized")
...
# how stronng is spatial autocorrelation relative to random sample of sites
...
# MCMC settings
ni <- 100 # ni test; used in the paper: 50000
nb <- 50 # nb test; used in the paper: 40000
nt <- 1 # nt test; used in the paper: 20
